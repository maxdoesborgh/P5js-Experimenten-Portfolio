...
function setup() {
    ...
    // Alleen de typografie aangepast naar Tim's stijl
    textFont("Helvetica");
    textStyle(BOLD);
}

function draw() {
    background(0, 45); // Jouw originele trail effect voor chaos
...
function renderStorm() {
    ...
    for (let i = 0; i < intensity; i++) {
        push();
        // Aangepast naar Tim's exacte felle roze kleur en wit
...
function renderZen(tx, ty) {
    push();
    noFill();
    // Het zen-effect behoudt jouw originele rustgevende kleurlaag
